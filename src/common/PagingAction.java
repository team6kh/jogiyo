...
public class PagingAction
{
    ...
    public PagingAction(String actionName, int currentPage, int totalCount, int blockCount, int blockPage)
    {
        ...
        {
            pagingHtml.append("<li><a href=" + actionName + ".action?currentPage=" + (startPage - 1) + ">");
        ...
        for (int i = startPage; i <= endPage; i++)
        {
            ...
            {
                pagingHtml.append("<li><a href=" + actionName + ".action?currentPage=");
                pagingHtml.append(i);
                pagingHtml.append(">");
                pagingHtml.append(i);
                pagingHtml.append("</a><li>");
        ...
        {
            pagingHtml.append("<li><a href=" + actionName + ".action?currentPage=" + (endPage + 1) + ">");
