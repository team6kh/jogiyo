					...
					<tr>
						<td colspan="10" align="center">
							...
							<form name="recipe_search" action="recipe_search.action" enctype="multipart/form-data">
								...
								<input name="mylist" type="button" value="전체글목록보기" onClick="javascript:location.href='listRecipe.action?currentPage=<s:property value="currentPage"  />';">
								...
								<div id="detailsearch" style="display: none">
									<table width="667" border="1" cellpadding="0" cellspacing="0">
										...
										<tr>
											...
											<td><select name="recipe_foodkind" style="width: 120px" id="statsType">
										...
										<tr>
											...
											<td colspan="3"><input type="text" id="recipe_timeinput1" size="5">&nbsp;~<input type="text" id="recipe_timeinput2" size="5"></td>
										</tr>
										<tr>
											<td align="center">비용</td>
											<td colspan="3"><input type="text" id="recipe_priceinput1" size="5">&nbsp;~<input type="text" id="recipe_priceinput2" size="5"></td>
										</tr>
										<tr>
											<td align="center" colspan="4"><input type="reset" value="초기화" />&nbsp;<input type="submit" value="검색" /></td>
										</tr>
