...
<body onload="ratingck()">
	...
	<script type="text/javascript">
		...
		function confirm() {
			...
			opener.window.location.href = "updateReviewPro.action?rest_num="+rest_num+"&review_rest_currentPage="+review_rest_currentPage+"&ccp="+ccp+"&review_num="+review_num+"&review_content="+review_content;
			self.close();
		}
