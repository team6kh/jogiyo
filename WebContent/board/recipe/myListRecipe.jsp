...
<body>
	...
	<div class="container">
		...
		<div class="col-md-12">
			<h3>MyRecipe 목록</h3>
			<p>내가 올린 레시피~~!!</p>
			<input type="button" class="btn btn-warning" value="게시판 사용 지침"
				onClick="recipeboardrules()">
			<div class="pull-right">

				<s:if test="#session.session_id != null">
					<input type="button" class="btn btn-default" value="마이페이지"
						onClick="javascript:location.href='mypageFormRecipe.action'" />
					</td>
				</s:if>
			</div>
		</div>
		...
		<div class="pull-right">
			...
			<input type="button" value="새로고침"
				onClick="javascript:location.href='myListRecipe.action?session_id=<s:property value="#session.session_id" />';">
		</div>
		<!-- /버튼 -->
						...
						<div id="detailsearch" style="display: none">
							<table width="667" border="1" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td colspan="3"><input type="text" id="recipe_timeinput1"
										size="5">&nbsp;~<input type="text"
										id="recipe_timeinput2" size="5"></td>
								</tr>
								<tr>
									<td align="center">비용</td>
									<td colspan="3"><input type="text" id="recipe_priceinput1"
										size="5">&nbsp;~<input type="text"
										id="recipe_priceinput2" size="5"></td>
								</tr>
								<tr>
