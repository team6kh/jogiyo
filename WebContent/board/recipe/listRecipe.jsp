	...
	<div class="container">
		...
		<div class="common-template">
			...
			<table width="900" border="0" cellspacing="0" cellpadding="2">
				...
				<tr>
					<td height="1" bgcolor="#BDBDBD" align="center">알고 있는 요리 레시피를 올려주세요~~! 혼자만 알고 있음, 안~돼!!</td>
				</tr>
				<tr>
					<td height="20"></td>
				</tr>
				<tr>
					<td align="left"><input type="button" value="게시판 사용 지침" onClick="recipeboardrules()"></td>
					<td align="right"><input type="button" value="마이페이지" 	onClick="javascript:location.href='mypageFormRecipe.action'" /></td>
				</tr>
			</table>
				...
				<tr>
					<td colspan="10" align="center">
						...
						<form name="recipe_search" action="recipe_search.action" enctype="multipart/form-data">
							...
							</select> <input name="mylist" type="button" value="내가쓴글"
								onClick="javascript:location.href='recipe_mylsit.action?recipe_memberwriter=<s:property value="recipe_memberwriter" />';">
