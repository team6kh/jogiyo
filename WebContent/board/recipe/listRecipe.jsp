				...
				<tr>
					<td colspan="10" align="center">
						...
						<form name="recipe_search" action="searchRecipe">
							...
							</select> <input name="mylist" type="button" value="내가쓴글" onClick="javascript:location.href='recipe_mylsit.action?recipe_memberwriter=<s:property value="recipe_memberwriter" />';">
