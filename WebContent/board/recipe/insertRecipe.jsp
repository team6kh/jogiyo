		    ...
		    <form name="inputWarning" action="updateRecipe.action" method="post" enctype="multipart/form-data"  onSubmit="submitContents(this);">
				...
				<table class="table table-stiped">
					...
					<tr>
						...
						<td width="300" colspan="3" align="left">
							<input type="text" size="40" maxlength="30" name="recipe_method" value="${resultClass.recipe_method}" required />
						</td>
					</tr>
					<tr>
						<td width="100" bgcolor="" align="center">소요 시간</td>
						<td width="100" align="left">
							<input type="text" name="recipe_time" value="${resultClass.recipe_time}" required /></td>
						<td width="100" bgcolor="" align="center">비용</td>
						<td width="100" align="left">
							<input type="text" name="recipe_price" value="${resultClass.recipe_price}" required /></td>
					</tr>
					<tr>
						<td width="100" bgcolor="" align="center">방법 및 상세내용</td>
						<td width="300" colspan="3" align="left">
							<s:textarea name="recipe_content" id="recipe_content" theme="simple" value="%{resultClass.recipe_content}" cssStyle="width:800px" required="required" /></td>
					</tr>
