				...
				<li><a href="#"><i
					...
					<ul>
						...
						<li><a href="bootstrap-forms.html">Bootstrap Form
								Elements</a></li>
						<li class="active"><a href="plugins.html">Form Plugins</a></li>
									...
									<table id="user" class="table table-bordered table-striped"
										...
										<tbody>
											<tr>
												...
												<td style="width: 65%"><a href="form-x-editable.html#"
													id="username" data-type="text" data-pk="1"
											...
											<tr>
												...
												<td><a href="form-x-editable.html#" id="status"
													...
													data-source="/status" data-original-title="Select status">Active</a></td>
											</tr>
											...
											<tr>
												...
												<td><a href="form-x-editable.html#" id="state2"
													data-type="typeaheadjs" data-pk="1" data-placement="right"
											...
											<tr>
												...
												<td><a href="form-x-editable.html#" id="country"
													data-type="select2" data-pk="1" data-select-search="true"
													data-value="BS" data-original-title="Select country"></a></td>
											</tr>
												...
												<div class="col-sm-6">
													...
													<div class="form-group">
														<input id="range-slider-2" type="text" name="range_2"
															...
															data-postfix=" €" data-from="30000" data-to="90000"
															data-hasgrid="true">
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-sm-6">
													<label><code>.slider .slider-danger</code></label> <input
														type="text" class="slider slider-danger" id="sal" value=""
											...
											<div class="row">
												...
												<div class="col-sm-6">
													<label><code>.slider .slider-info</code></label> <input
														type="text" class="slider slider-info" id="sa4" value=""
